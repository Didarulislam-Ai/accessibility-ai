...
"[project]/.next-internal/server/app/api/pricing/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET() {
    try {
        ...
        const pricingData = products.data.filter((product)=>product.id === basicProductId || product.id === proProductId || product.id === enterpriseProductId).map((product)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__73636c4e._.js.map